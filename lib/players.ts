...
export const PLAYERS = [
  ...
  { id: 'dan',      playerName: 'DAN',      character: 'William Epshire', initial: 'W', img: '/images/players/dan.png' },
  { id: 'donnie',   playerName: 'DONNIE',   character: 'Lyn Deathwing',  initial: 'D', img: '/images/players/donnie.png' },
] as const;
