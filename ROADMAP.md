...
Each item is a checkbox list entry with a version tag. Tags look like `<!-- common-v4 -->`. Untagged items are ignored. Versions run v3 (maps, in flight) through v19 (planning horizon).
...
### v13 — news propagation + celestial
...
- [ ] Flip signup allowlist off (public DM signup opens) <!-- common-v17 -->
- [ ] Loremaster tier operations <!-- common-v17 -->
- [ ] Delegated moderation for Loremasters <!-- common-v17 -->
- [ ] `/common-world/chronicle` public activity log <!-- common-v17 -->
- [ ] Research TODO: ethical content moderation best practices for D&D <!-- common-v17 -->

### v18 — contributor portfolios

- [ ] `/dms/[handle]` full portfolio page (logged-in only) <!-- common-v18 -->
- [ ] Cross-campaign DM history surface <!-- common-v18 -->
- [ ] Reference graph visualization <!-- common-v18 -->

### v19 — ERC-20 token bridge (planning only)

- [ ] Planning doc for common currency ERC-20 token <!-- common-v19 -->
- [ ] Legal review (KYC, tax, real-money stakes) <!-- common-v19 -->
